...
const BodySection = () => {
    return (
        <div className={styles.cuerpo}>
            ...
            <h2 className={styles.h2}>Esta aplicación fue desarrollada por Marcos Zalazar y Pablo Toledo para rendir el final de la materia MCGA en Agosto del 2.023</h2>
